...
class SearchOnReferenceCitationSimpleAccentedTest < ActiveSupport::TestCase
  test "search on reference citation simple accented" do
    reference = references(:hulten_with_diacritic)
    citation_wo_accent = 'citation includes hulten with diacritic'
    params =  ActiveSupport::HashWithIndifferentAccess
              .new(query_target: "reference",
                   query_string: %(citation: #{citation_wo_accent}),
