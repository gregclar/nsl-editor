...
class TypeaheadForSynonymyNothovarietasTest < ActiveSupport::TestCase
  ...
  def check_infraspecific_exclusions
    %w[Regio Regnum Division Classis Subclassis Superordo Ordo Subordo Familia
       ...
       Subseries Superspecies Nothovarietas].each do |rank_string|
  ...
  def check_the_rest
    %w[Subspecies Varietas Subvarietas Subforma [n/a] [unknown] [unranked]
     [infraspecies] Forma nothomorph. morphological\ var.]
      .each do |rank_string|
