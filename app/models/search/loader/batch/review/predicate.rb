...
#
class Search::Loader::Batch::Review::Predicate
  ...
  def initialize(field, value)
    ...
    rule = Search::Loader::Batch::Review::FieldRule::RULES[@canon_field] || EMPTY_RULE
    @is_null = value.blank?
    apply_rule(rule)
  ...
  def debug(s)
    Rails.logger.debug("Search::Loader::Batch::Review::Predicate - #{s}")
  end

  def inspect
    "Search::Loader::Batch::Review::Predicate: canon_field: #{@canon_field}"
  end
  ...
  def build_canon_field(field)
    if Search::Loader::Batch::Review::FieldRule::RULES.key?(field)
      field
    elsif Search::Loader::Batch::Review::FieldRule::RULES.key?(
      Search::Loader::Batch::Review::FieldAbbrev::ABBREVS[field]
    )
      Search::Loader::Batch::Review::FieldAbbrev::ABBREVS[field]
    else
