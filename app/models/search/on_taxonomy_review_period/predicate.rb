...
#
class Search::OnTaxonomyReviewPeriod::Predicate
  ...
  def initialize(field, value)
    ...
    rule = Search::OnTaxonomyReviewPeriod::FieldRule::RULES[@canon_field] || EMPTY_RULE
    @is_null = value.blank?
    apply_rule(rule)
  ...
  def build_canon_field(field)
    ...
    if Search::OnTaxonomyReviewPeriod::FieldRule::RULES.key?(field)
      field
    elsif Search::OnTaxonomyReviewPeriod::FieldRule::RULES.key?(
      Search::OnTaxonomyReviewPeriod::FieldAbbrev::ABBREVS[field]
    )
      Search::OnTaxonomyReviewPeriod::FieldAbbrev::ABBREVS[field]
    else
